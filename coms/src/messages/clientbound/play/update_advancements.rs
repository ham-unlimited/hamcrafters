use crate::{
    McPacket,
    codec::{
        identifier::Identifier, prefixed_array::PrefixedArray, prefixed_optional::PrefixedOptional,
        var_int::VarInt,
    },
...
pub struct Advancement {
    ...
    display_data: PrefixedOptional<AdvancementDisplay>,
    ...
    nested_requirements: PrefixedArray<String>,
...
impl<'de> Deserialize<'de> for AdvancementFrameType {
    ...
    where
        D: serde::Deserializer<'de>,
    {
        let frame_type: u8 = u8::deserialize(deserializer)?;
...
pub struct AdvancementProgress {
    ...
    date_of_achieving: PrefixedOptional<i64>,
}
